				...
				?>
					<div class="col-md-12">
						...
						<div>
							...
							<div><textarea name="Q1" rows="5" class="form-control" cols="150" required oncopy="return false" onpaste="return false" oncut="return false"></textarea></div>
						</div>
						<br>
						<div>
							<h4> <strong>Q2. <?php $Q_2=$row['Q2']; echo $Q_2; ?></strong></h4>
							<div><textarea name="Q2" rows="5" class="form-control" cols="150" required oncopy="return false" onpaste="return false" oncut="return false"></textarea></div>
						</div>
						<br>
						<div>
							<h4> <strong>Q3. <?php $Q_3=$row['Q3']; echo $Q_3; ?></strong></h4>
							<div><textarea name="Q3" rows="5" class="form-control" cols="150" required oncopy="return false" onpaste="return false" oncut="return false" ></textarea></div>
						</div>
						<br>
						<div>
							<h4> <strong>Q4. <?php $Q_4=$row['Q4']; echo $Q_4; ?></strong></h4>
							<div><textarea name="Q4" rows="5" class="form-control" cols="150" required oncopy="return false" onpaste="return false" oncut="return false"></textarea></div>
						</div>
						<br>
						<div>
							<h4> <strong>Q5. <?php $Q_5=$row['Q5']; echo $Q_5; ?></strong></h4>
							<div><textarea name="Q5" rows="5" class="form-control" cols="150" required oncopy="return false" onpaste="return false" oncut="return false"></textarea></div>
						</div>
						<br>
					...
					?>
						...
						<br>
						<center><button type="submit" name="done" class="btn btn-success" required style="border-radius:50px 50px;">Submit Answers</button></center>
					</div>
